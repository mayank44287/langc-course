...
def demo_batch_execution():
    ...
    # batch - run with mulitiple inputs
    inputs = [
...
def first_exercise_chain():
    ...
    prompt = ChatPromptTemplate.from_template("Create a marketing tagline for product named '{product}' targetting '{audience}'")
    model = ChatOpenAI(model="gpt-4o-mini", temperature=0.7)
    parser = StrOutputParser()
