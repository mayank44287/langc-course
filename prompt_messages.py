...
#     input_language = "English", output_language = "Hindi", text= "I love programming."
# )
...
model = init_chat_model(model="gpt-4o-mini", temperature=0)
response = model.invoke(final_prompt.format_messages(input="married"))
